...
import { getNomeAmigavelRole } from "./auth.js";
    ...
    tr.innerHTML = `
              ...
              user.usuario
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <span class="px-2 py-1 rounded-full text-xs font-bold uppercase ${roleClass}">
                        ${getNomeAmigavelRole(user.role || "operador")}
                    </span>
                </td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                <button onclick="editarUser(${
                  user.id
                })" class="text-primary hover:text-blue-900 mr-4" title="Editar">
                    <i class="fas fa-edit"></i>
                </button>
                <button onclick="deletarUser(${user.id}, '${
      user.usuario
